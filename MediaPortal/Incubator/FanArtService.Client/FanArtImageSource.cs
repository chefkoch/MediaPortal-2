...
namespace MediaPortal.Extensions.UserServices.FanArtService.Client
{
  public class FanArtImageSource : MultiImageSource
  {
    ...
    protected void UpdateSource(AbstractProperty property, object oldvalue)
    {
      ...
      UriSource = string.Format("http://{0}/FanartService?mediatype={1}&fanarttype={2}&name={3}&width={4}&height={5}{6}", _baseUrl, FanArtMediaType, FanArtType, HttpUtility.UrlEncode(FanArtName), MaxWidth, MaxHeight, cacheHint);
    }
