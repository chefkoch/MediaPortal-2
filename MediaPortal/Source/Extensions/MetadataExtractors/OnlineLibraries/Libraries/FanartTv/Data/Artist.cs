...
namespace MediaPortal.Extensions.OnlineLibraries.Libraries.FanartTv.Data
{
  ...
  public class Artist
  {
    ...
    public List<Image> ArtistBackgrounds { get; set; }

    [DataMember(Name = "artistthumb")]
    public List<Image> ArtistThumbs { get; set; }

    [DataMember(Name = "musiclogo")]
    public List<Image> MusicLogos { get; set; }

    [DataMember(Name = "hdmusiclogo")]
    public List<Image> MusicLogosHD { get; set; }

    [DataMember(Name = "musicbanner")]
    public List<Image> MusicBanners { get; set; }

    public void SetIds()
    {
      Album.SetIds(Albums);
      
      string category = ImageCategory.Artist.ToString().ToLower();
      Image.SetIds(ArtistBackgrounds, category, MBID_ID, "artistbackground");
      Image.SetIds(ArtistThumbs, category, MBID_ID, "artistthumb");
      Image.SetIds(MusicLogos, category, MBID_ID, "musiclogo");
      Image.SetIds(MusicLogosHD, category, MBID_ID, "hdmusiclogo");
      Image.SetIds(MusicBanners, category, MBID_ID, "musicbanner");
    }
  }
}
